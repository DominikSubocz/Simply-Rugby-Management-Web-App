      ...
      <?php foreach ($juniorSkills as $juniorSkill): ?>
        ...
        <?php if (Utils::escape($juniorSkill["category"]) == "Passing") {
          ...
          <label class="col-sm-2 col-form-label-sm"
            for="<?php echo strtolower($inputName); ?>"><?php if ($juniorSkill["category"] == "Passing") {
                 echo Utils::escape($juniorSkill["skill_name"]) . ' Skill';
               } ?></label><br>
          ...
          <label class="col-sm-2 col-form-label-sm"
            for="<?php echo $commentField; ?>"><?php if ($juniorSkill["category"] == "Passing") {
                 echo 'Comment';
               } ?></label><br>
    ...
    <div id="tackling-form">
      ...
      <?php foreach ($juniorSkills as $juniorSkill): ?>
        ...
        <?php if (Utils::escape($juniorSkill["category"]) == "Tackling") {
          ?>
          <h3>
            <?php if ($juniorSkill["category"] == "Passing") {
              echo Utils::escape($juniorSkill["skill_name"]) . ' Skill';
            } ?>
          </h3>
          <label class="col-sm-2 col-form-label-sm"
            for="<?php echo strtolower($inputName); ?>"><?php if ($juniorSkill["category"] == "Tackling") {
                 echo Utils::escape($juniorSkill["skill_name"]) . ' Skill';
               } ?></label><br>
          <input type="text" name="<?php echo strtolower($inputName); ?>"
            placeholder="<?php echo Utils::escape($juniorSkill["skill_level"]); ?>"
            value="<?php echo ${strtolower($inputName)}; ?>">
          <!-- Get placeholder from the array, and use the right value -->
          <p class="alert alert-danger"><?php echo ${$errorMsg}; ?></p><br> <!-- Get error message from the array -->

          <label class="col-sm-2 col-form-label-sm"
            for="<?php echo $commentField; ?>"><?php if ($juniorSkill["category"] == "Tackling") {
                 echo 'Comment';
               } ?></label><br>
          <input type="text" name="<?php echo $commentField; ?>" placeholder="<?php echo ${$commentPlaceholder}; ?>"
            value="<?php echo ${$commentField}; ?>">
    ...
    <div id="kicking-form">
      ...
      <?php foreach ($juniorSkills as $juniorSkill): ?>
        ...
        <?php if (Utils::escape($juniorSkill["category"]) == "Kicking") {
          ...
          <label class="col-sm-2 col-form-label-sm"
            for="dob"><?php if ($juniorSkill["category"] == "Kicking") {
              echo Utils::escape($juniorSkill["skill_name"]) . ' Skill';
            } ?></label><br>
          <input type="text" name="<?php echo strtolower($inputName); ?>"
            placeholder="<?php echo Utils::escape($juniorSkill["skill_level"]); ?>"
          ...
          <label class="col-sm-2 col-form-label-sm"
            for="<?php echo $commentField; ?>"><?php if ($juniorSkill["category"] == "Kicking") {
                 echo 'Comment';
               } ?></label><br>
          <input type="text" name="<?php echo $commentField; ?>" placeholder="<?php echo ${$commentPlaceholder}; ?>"
            value="<?php echo ${$commentField}; ?>">
