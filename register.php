...
<main class="content-wrapper loginRegister-content my-5">
    ...
    <form method="POST" action="" class="form">
        ...
        <input id="password-field" type="password" class=" password-field" name="passwordOne"
        ...
        <div id="criteria-box" class="py-2 password-criteria-card">
            ...
            <div>
                <ul>
                    <li id="password-length-box"><i id="length-mark" class="fa fa-times" aria-hidden="true"></i>Password
                        must be at least 12 characters long.</li>
                    <li id="password-match-box"><i id="match-mark" class="fa fa-times" aria-hidden="true"></i>Passwords
                        must match.</li>
                </ul>
            </div>
        </div>
        ...
        <input id="password-field-two" class=" password-field" type="password" oninput="checkPasswordCriteria()"
            name="passwordTwo">

        <input class="btn btn-dark" type="submit" name="registerSubmit" onclick="return validateRegister()"
            value="Register account">

        <!-- Only output if there is an error in the registration form -->
        <?php if ($output && isset($_POST["registerSubmit"])) {
            echo $output;
        } ?>
    </form>
