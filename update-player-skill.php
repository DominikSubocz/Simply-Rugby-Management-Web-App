...
$player = Player::getplayer($_GET["id"]); ///< Get player's details
$playerId = $player['player_id']; ///< Get ID of player

$pageTitle = "player not found"; ///< Default title

/**
 * Set the page title to display the details of player if the player array is not empty.
 *
...
$playerSkills = Player::getPlayerSkills($_GET["id"]); ///< Get skills of specific player

/**
 * Escape and assign values from the $playerSkills array to respective variables for security purposes.
 *
 * @param array $playerSkills An array containing information about the player skills.
 * 
 */
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (
     ...
     * @param int $juniorId - Int containing ID of player for which skill will be updated.
     */
