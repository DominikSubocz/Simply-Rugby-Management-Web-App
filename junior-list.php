 ...
 * Redirect to the 'update-junior.php' page with the IDs from the 'check_list' array as query parameters.
 */
 ...
 * If clicked check if the 'check_list' POST parameter is not empty.
 * Redirect to the 'delete-junior.php' page with the IDs from the 'check_list' array as query parameters.
 */
 ...
 * If clicked check if the 'check_list' POST parameter is not empty.
 * Redirect to the 'update-junior-skill.php' page with the IDs from the 'check_list' array as query parameters.
 */
...
<main class="content-wrapper profile-list-content my-5">
  ...
  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <div class="bg-dark text-white d-flex p-2">
      ...
      <input class="btn btn-secondary mx-2 my-2" type="submit" id="updateSkillBtn" name="updateSkillSubmit"
        value="Update Junior Skill">
    ...
    <table class="table" id="customDataTable">
      ...
      <tbody>
        ...
        /// Get all juniors from the database and output list of juniors
        $juniors = Junior::getAllJuniors();
        Components::allJuniors($juniors);
