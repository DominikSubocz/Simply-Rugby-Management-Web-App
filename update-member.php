...
<main class="content-wrapper contact-content">
    ...
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>?id=<?php echo $member["member_id"]; ?>"
        ...
        <div id="personal-details-form">
            ...
            <input type="text" name="name"
                placeholder="<?php echo $firstNamePlaceholder . ' ' . $lastNamePlaceholder; ?> "
                value="<?php echo $name; ?>">
        ...
        <div id="address-details-form" class="add-form-section">
            ...
            <input type="text" placeholder="<?php echo $address1Placeholder; ?>" s name="address1"
