...
<main class="content-wrapper contact-content my-5">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        ...
        <div id="guardian-details-form" class="add-form-section">
            ...
            <label class="col-sm-2 col-form-label-sm" for="guardianName"><span class="required">*</span>Guardian's
                name:</label><br>
            <input type="text" name="guardianName" value="<?php echo $guardianName; ?>">
            <p class="alert alert-danger"><?php echo $guardianNameErr; ?></p><br>

            <label class="col-sm-2 col-form-label-sm" for="guardianContact"><span class="required">*</span>Contact
                Number:</label><br>
            ...
            <label class="col-sm-2 col-form-label-sm" for="relationship"><span
                    class="required">*</span>Relationship:</label><br>
            <input type="text" name="relationship" value="<?php echo $relationship; ?>">
            <p class="alert alert-danger"><?php echo $relationshipErr; ?></p><br>


            <label class="col-sm-2 col-form-label-sm" for="guardianAddress11"><span class="required">*</span>Address
                Line 1:</label><br>
            ...
            <label class="col-sm-2 col-form-label-sm" for="guardianCity1"><span
                    class="required">*</span>City:</label><br>
            ...
            <label class="col-sm-2 col-form-label-sm" for="guardianPostcode1"><span
                    class="required">*</span>Postcode:</label><br>
            ...
            <div id="second-guardian-form">
                ...
                <label class="col-sm-2 col-form-label-sm" for="relationship2"><span
                        class="required">*</span>Relationship:</label><br>
                <input type="text" name="relationship2" value="<?php echo $relationship2; ?>">
                <p class="alert alert-danger"><?php echo $relationship2Err; ?></p><br>

                <label class="col-sm-2 col-form-label-sm" for="guardianAddress21"><span class="required">*</span>Address
                    Line 1:</label><br>
                ...
                <label class="col-sm-2 col-form-label-sm" for="guardianCity2"><span
                        class="required">*</span>City:</label><br>
                <input type="text" name="guardianCity2" value="<?php echo $guardianCity2; ?>">
                <p class="alert alert-danger"><?php echo $guardianCity2Err; ?></p><br>

                <label class="col-sm-2 col-form-label-sm" class="col-sm-2 col-form-label-sm"
                    for="guardianCounty2">County:</label><br>
                ...
                <label class="col-sm-2 col-form-label-sm" for="guardianPostcode2"><span
                        class="required">*</span>Postcode:</label><br>
        ...
        <div id="doctor-details-form">
            <label class="col-sm-2 col-form-label-sm" for="doctorName"><span class="required">*</span>Doctor
                Name:</label><br>
            <input type="text" name="doctorName" value="<?php echo $doctorName; ?>">
            <p class="alert alert-danger"><?php echo $doctorNameErr; ?></p><br>

            <label class="col-sm-2 col-form-label-sm" for="doctorContact"><span class="required">*</span>Contact
                Number:</label><br>
