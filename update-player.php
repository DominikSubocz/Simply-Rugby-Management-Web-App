...
<main class="content-wrapper contact-content">
    ...
    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>?id=<?php echo $player["player_id"]; ?>"
        ...
        <div id="kin-details-form" class="add-form-section">
            ...
            <input type="text" name="kinContact" placeholder="<?php echo $kinContactNumberPlaceholder; ?>"
                value="<?php echo $kinContact; ?>">
        ...
        <div id="doctor-details-form">
            ...
            <input type="text" name="doctorName"
                placeholder="<?php echo $doctorFirstNamePlaceholder . ' ' . $doctorLastNamePlaceholder; ?>"
            ...
            <input type="text" name="doctorContact" placeholder="<?php echo $doctorContactPlaceholder; ?>"
                value="<?php echo $doctorContact; ?>">
