...
<main class="content-wrapper contact-content my-5">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
        ...
        <div id="personal-details-form">
            ...
            <label class="col-sm-2 col-form-label-sm" for="dob"><span class="required">*</span>Date of
                Birth:</label><br>
        ...
        <div id="address-details-form" class="add-form-section">
            <label class="col-sm-2 col-form-label-sm" for="address1"><span class="required">*</span>Address Line
                1:</label><br>
            ...
            <label class="col-sm-2 col-form-label-sm" for="postcode"><span
        ...
        <div id="kin-details-form" class="add-form-section">
            ...
            <label class="col-sm-2 col-form-label-sm" for="kinContact"><span class="required">*</span>Contact
                Number:</label><br>
