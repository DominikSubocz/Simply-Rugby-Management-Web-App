...
<tr class="hover-overlay">
  <td data-th="Game Name" class="game-name-label">
    <p><?php echo $gameName; ?></p>
  </td>
  <td data-th="Home Team" class="squad-label">
    <p><?php echo $squadId; ?></p>
  </td>
  <td data-th="Opposition Team" class="opposition-label">
    <p><?php echo $squadId; ?></p>
  </td>
  <td data-th="Start Date" class="start-date-label">
    <p><?php echo $gameStart; ?></p>
  </td>
  <td data-th="End Date" class="end-date-label">
    <p><?php echo $gameEnd; ?></p>
  </td>
  <td data-th="Location" class="location-label">
    <p><?php echo $gameLocation; ?></p>
  </td>
  <td data-th="Kickoff Time" class="kickoff-label">
    <p><?php echo $gameKickoff; ?></p>
  </td>
  <td data-th="Result" class="result-label">
    <p><?php echo $gameResult; ?></p>
  </td>
  <td data-th="Score" class="score-label">
    <p><?php echo $gameScore; ?></p>
  </td>
