...
<tr class="hover-overlay">
  <td data-th="Session Name" class="session-name-label">
    <p><?php echo $sessionName; ?></p>
  </td>
  <td data-th="Coach Organising" class="coach-label">
    <p><?php echo 'Coach Number: ' . $coachId; ?></p>
  </td>
  <td data-th="Squad Participating" class="squad-label">
